...
public struct FancyScrollView: View {
    ...
    public var body: some View {
        if let header = header {
            return AnyView(
                HeaderScrollView(title: title, titleView: titleView, titleColor: titleColor,
...
extension FancyScrollView {
    ...
    public init<A: View, B: View, C: View>(title: String = "", titleView: () -> C?, titleColor: Color = Color.white,
        ...
        self.init(title: title, titleView: nil, titleColor: titleColor,
                  headerHeight: headerHeight,
